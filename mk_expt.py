...
def getOpts(expt_name):
	...
	elif expt_name == 'sparsesync':
		opt['which_algs_paths'] = [
			"CondAVTransformer_VNet_randshift_2s_GH_vqgan_no_earlystop_multiple",
		]		 # paths to images generated by algoritms, e.g. {'my_alg','baseline_alg'}
	elif expt_name == 'sparsesync_tolerance':
		opt['which_algs_paths'] = [
			"CondAVTransformer_VNet_randshift_2s_GH_vqgan_no_earlystop_multiple_tolerance",
		]		 # paths to images generated by algoritms, e.g. {'my_alg','baseline_alg'}
	else:
...
def mk_expt(expt_name):
	...
	s = '[\"' + '\",\"'.join(opt['which_algs_paths']) + '\"];'
	html = html.replace('{{ALGORITHMS}}', s)
